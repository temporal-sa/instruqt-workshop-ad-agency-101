...
In the [button label="CLI"](tab-4) tab, replace the placeholders and
export:
...
Open `08-to-the-cloud/src/main/java/workshop/CloudWorker.java` in the
[button label="Editor"](tab-0) tab and inspect its service-stub connection
configuration.
