...
public class HashtagActivitiesImpl implements HashtagActivities {
  ...
  public List<String> fetchHashtags(String channel) {
    try {
      ...
      // TODO: Part B — read body.get("hashtags"), cast it to List<String>,
      // and return it. The solution shows the local @SuppressWarnings needed
      // for Jackson's generic Map value.
      return List.of();
