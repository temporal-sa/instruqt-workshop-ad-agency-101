...
export async function socialPostWorkflow(channel: string): Promise<string> {
  ...
  // TODO: Part C — include fetchHashtags in the proxy above, then:
  // const hashtags = await fetchHashtags(channel);
  // The proxy schedules an Activity; it does not call the implementation
  // directly inside the Workflow sandbox.
